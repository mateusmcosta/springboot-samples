...
@Component(value = "ServiceBImpl")
public class ServiceBImpl implements Service {

    private static Logger LOG = LoggerFactory.getLogger(ServiceBImpl.class);
    ...
    public String success() {
        return "Hello World from service B Impl";
    }
    ...
    public String ignoreException() {
        throw new BusinessException("This exception is ignored by the CircuitBreaker of service B Impl");
    }
    ...
    public Flux<String> fluxTimeout() {
        return Flux.just("Hello World from service B Impl")
                .delayElements(Duration.ofSeconds(10));
    }

    @Override
    public Mono<String> monoSuccess() {
        return Mono.just("Hello World from service B Impl");
    }
    ...
    public CompletableFuture<String> futureSuccess() {
        return CompletableFuture.completedFuture("Hello World from service B Impl");
    }
