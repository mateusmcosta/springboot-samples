package com.github.mateusmcosta.circuitbreaker.controller;

import com.github.mateusmcosta.circuitbreaker.service.Service;
...
public class BackendCController {
    ...
    public BackendCController(@Qualifier("ServiceCImpl")Service businessCService){
